...
class FoxaSprite extends FlxSprite
{
	...
	public function new(fileName:String, ?fileFolder:String, ?fileAnim:String, ?looped:Bool = false, ?antialiasSet:Bool = true)
	{
		super();
