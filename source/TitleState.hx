...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		gfDance.frames = Paths.getSparrowAtlas('ui/foxaDanceTitle');
		...
		var engineversionText:FlxText = new FlxText(5, FlxG.height - 18, 0, "FNF Vs. Foxa SE 3.0 ALPHA", 12);
		...
		createCoolText(['Engine Base Created by:']);
